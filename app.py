...
st.markdown("""
    ...
    .stTabs [data-baseweb="tab"] {
        ...
        background: transparent !important; border: none !important; color: #8c857e !important;
    }
    .stTabs [aria-selected="true"] { color: #5d5750 !important; font-weight: 600 !important; border-bottom: 2px solid #7c8370 !important; }

    .stButton>button {
        background: #7c8370 !important; color: #fdfcfb !important;
...
if not df_u.empty:
    ...
    with tab_r:
        ...
        # Bezpieczne statystyki (pomijają NaN)
...
with col2:
    with st.popover("✨ KOREKTA", use_container_width=True):
        if not df_u.empty:
            sel_date = st.selectbox("Wybierz dzień:", df_u['Data'].tolist()[::-1])
